...
def main():
    ...
    train_aug_loader = DataLoader(getImageLabel(augmented=f'C:/MonkeyPox 2/Dataset/Augmented Images', folds=folds, subdir=['Train']), batch_size=BATCH_SIZE, shuffle=True)
    train_ori_loader = DataLoader(getImageLabel(original=f'C:/MonkeyPox 2/Dataset/Augmented Images', folds=folds, subdir=['Train']), batch_size=BATCH_SIZE, shuffle=True)
    vali_loader = DataLoader(getImageLabel(original=f'C:/MonkeyPox 2/Dataset/Augmented Images', folds=folds, subdir=['Valid']), batch_size=BATCH_SIZE, shuffle=False)
